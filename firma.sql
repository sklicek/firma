...
INSERT INTO `kontenrahmen` (`id_konto`, `konto_nr`, `bezeichnung`, `typ`, `zeile_nr`) VALUES
(1, 100, 'Allgemeines Ausgabenkonto (kein passenderes Konto?)', 'A', 66),
(2, 110, 'Waren, Rohstoffe und Hilfsstoffe	', 'A', 26),
(3, 111, 'Bürobedarf', 'A', 57),
(4, 112, 'Fortbildung, Fachliteratur', 'A', 57),
(5, 113, 'Verbrauchsmaterial (bitte auf Konto 110 buchen)', 'A', 26),
(6, 114, 'Rechts- und Steuerberatung, Buchführung', 'A', 52),
(7, 120, 'Bezogene Leistungen für unmittelbaren Betriebszweck', 'A', 27),
(8, 121, 'Porto', 'A', 57),
(9, 122, 'Telekommunikation', 'A', 49),
(10, 123, 'Energie', 'A', 66),
(11, 124, 'Beiträge, Gebühren, Abgaben und Versicherungen (ohne Gebäude und Kfz)', 'A', 55),
(12, 125, 'Werbekosten (z.B. Inserate, Werbespots, Plakate)', 'A', 60),
(13, 130, 'Gehälter, Löhne, Versicherungsbeiträge für Arbeitnehmer', 'A', 28),
(14, 140, 'Aufwendungen für geringwertige Wirtschaftsgüter (GWG)', 'A', 43),
(15, 150, 'Miete/Pacht für Geschäftsräume', 'A', 46),
(16, 155, 'Miete/Leasing für bewegliche Wirtschaftsgüter', 'A', 53),
(17, 160, 'Aufwendungen für Grundstücke', 'A', 48),
(18, 170, 'Aufwendungen für ein häusl. Arbeitszimmer', 'A', 70),
(19, 180, 'Verpflegungsmehraufwendungen', 'A', 69),
(20, 181, 'Fahrtkosten öffentlich (Bahn, ÖPNV, Taxi)', 'A', 83),
(21, 182, 'Übernachtungs- und Reisenebenkosten bei Geschäftsreisen', 'A', 50),
(22, 183, 'Privat-PKW für betriebliche Fahrten', 'A', 84),
(23, 184, 'Laufende und feste KFZ-Kosten ohne AFA und Zinsen', 'A', 83),
(24, 185, 'Miete / Aufwendungen für doppelte Haushaltsführung', 'A', 47),
(25, 186, 'KFZ-Leasingkosten', 'A', 81),
(26, 187, 'Steuern, Versicherung, Maut für KFZ', 'A', 82),
(27, 188, 'KFZ-Kosten für Wege zwischen Wohnung und Betriebsstätte; Familienheimfahrten', 'A', 85),
(28, 189, 'Mindestens abziehbare KFZ-Kosten für Wege zw. Wohnung und Betriebsstätte (Entf.pauschale); Familienheimfahrten	', 'A', 86),
(29, 190, 'Geschenke - abziehbar', 'A', 67),
(30, 195, 'Geschenke - nicht abziehbar', 'A', 67),
(31, 200, 'Bewirtung - abziehbar', 'A', 68),
(32, 205, 'Bewirtung - nicht abziehbar', 'A', 68),
(33, 210, 'Sonstige abziehbare Betriebsausgaben', 'A', 71),
(34, 215, 'Sonstige nicht abziehbare Betriebsausgaben', 'A', 71),
(35, 220, 'Instandhaltung und Reparaturen', 'A', 54),
(36, 230, 'Betriebsausgabenpauschale für bestimmte Berufsgruppen', 'A', 23),
(37, 235, 'Freibetrag nach §3 Nr.26 und 26a EStG', 'A', 23),
(38, 240, 'Schuldzinsen (Finanzierung von Anschaffungs-/Herstellungskosten von Wirtschaftsgütern)', 'A', 61),
(39, 245, 'Übrige Schuldzinsen (nicht abziehbar)', 'A', 46),
(40, 246, 'Übrige Schuldzinsen (abziehbar)', 'A', 62),
(41, 300, 'AfA auf unbewegliche Wirtschaftsgüter', 'A', 29),
(42, 310, 'AfA auf immaterielle Wirtschaftsgüter', 'A', 30),
(43, 320, 'AfA auf bewegliche Wirtschaftsgüter', 'A', 31),
(44, 330, 'Sonderabschreibungen nach §7g EStG', 'A', 41),
(45, 340, 'Herabsetzungsbeträge nach §7g Abs. 2 EStG', 'A', 42),
(46, 350, 'Auflösung Sammelposten nach §6 Abs. 2a EStG', 'A', 44),
(47, 360, 'Restbuchwert der im Kalenderjahr/Wirtschaftsjahr ausgeschiedenen Anlagegüter', 'A', 45),
(48, 496, 'Gewerbesteuer - nicht abziehbar', 'A', 71),
(49, 497, 'Gewerbesteuer - abziehbar', 'A', 71),
(50, 498, 'Vorsteuerbeträge', 'A', 63),
(51, 499, 'An das FA gezahlte Umsatzsteuer', 'A', 64),
(52, 500, 'Allgemeines Einnahmenkonto', 'E', 11),
(53, 600, 'Veräußerung und Entnahme von Anlagevermögen', 'E', 18),
(54, 610, 'Sonstige Sach-, Nutzungs- und Leistungsentnahmen', 'E', 20),
(55, 620, 'Private KFZ-Nutzung', 'E', 19),
(56, 630, 'Private Telefonnutzung', 'E', 20),
(57, 998, 'Vereinnahmte Umsatzsteuer', 'E', 16),
(58, 999, 'Vom FA erstattete Umsatzsteuer', 'E', 17);

-- --------------------------------------------------------

--
-- Stellvertreter-Struktur des Views `krechnungen`
...
--
-- Stellvertreter-Struktur des Views `krechnungen_eingang`
-- (Siehe unten für die tatsächliche Ansicht)
--
...
--
-- Stellvertreter-Struktur des Views `krechnungen_offen`
-- (Siehe unten für die tatsächliche Ansicht)
--
...
CREATE TABLE `kunden` (
  ...
  `plz` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ort` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
--
-- Tabellenstruktur für Tabelle `rechnungen_eingang`
--
...
--
-- Struktur des Views `krechnungen_eingang`
--
...
--
-- Indizes für die Tabelle `rechnungen_eingang`
--
